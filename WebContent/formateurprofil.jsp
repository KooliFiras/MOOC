					...
					<nav class="main-nav">
                        <ul class="clear-fix">
                            ...
                            <li>
								...
								<ul>
									<li><a href="formateurdash">Dashboard</a></li>
...
<div class="row">
  ...
  <div class="row">
    ...
    <div class=" personal-info">
      ...
      <s:form class="form-horizontal" action="formateursaveProfile" method="post" enctype="multipart/form-data">
      <div class="col-md-4">
      <div class="text-center">
         <img class="media-object dp img-circle" src="<s:property value="formateur.userImageFileName"/>"  style="width: 190px;height:190px;margin-left:80px;">

        <h6>Téléchargez votre photo...</h6>
        <input type="file" name ="formateur.userImage" class="text-center center-block well well-sm">
      </div>
    </div>
    <div class="col-md-8">
        <div class="form-group">
          ...
          <div class="col-lg-8">
            <input class="form-control" name="formateur.nom" value="<s:property value="formateur.nom" />" type="text">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-lg-8">
            <input class="form-control" name="formateur.titre" value="<s:property value="formateur.titre" />" type="text">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-lg-8">
            <input class="form-control" name="formateur.poste" value="<s:property value="formateur.poste" />" type="text">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-lg-8">
            <input class="form-control" value="<s:property value="formateur.email" />" name="formateur.email" type="text">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-8">
            <input class="form-control" name="formateur.motpasse" type="password">
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
			  				...
			  				<label class="col-md-3 control-label" >Déscription</label>
			  			 	<div class="col-md-8">
			  			 	<textarea  rows="4" class="form-control" name="formateur.description" required> <s:property value="formateur.description"/></textarea>
