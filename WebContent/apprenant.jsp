	...
	<header>
                        ...
                        <ul class="clear-fix">
							...
							<li>
								...
								<ul>
									...
									<li><a href="apprenantprofile">Mon profile</a></li>
		...
		<div class="page-title">
            ...
            <a class="pull-left" href="#">
                <img class="media-object dp img-circle" src="<s:property value="apprenant.userImageFileName"/>" style="width: 190px;height:190px; ">
            </a>

				<h1 class="">Bienvenu(e) <s:property value="apprenant.nom"/> </h1>
